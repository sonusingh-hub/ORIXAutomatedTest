...
#   Summary tab Inputs and data verification
  ...
  Scenario: TC002_Verify Introducer is able to Request a quote and Submit the application for New Asset and Dealer Pricing with Chattel Mortgage for Agricultural Equipment using Existing App
    Given I setup environment and login with role "introducer"
    ...
    Then I click on button "Complete Quote"
    Then I click on button "Proceed Quote"
    Then I click on element with text "Existing Application[2]"
    Then I populate field "Please select an application to attach your quote to" with excel "excel:Application Number"
    Then I click on button "REMAP QUOTE"
    Then I verify text "Your application has been mapped to the new quote" is present
    Then I click on button "Close"


  Scenario: TC003_Verify creditManager is able to validate the credit rules and manually overwrite credit decision
    Given I setup environment and login with role "creditManager"
    Given I load test data for "TC003" from "06_SMB_End2End"
...
#    Then I verify grid "" column "Value" row "[3]" contains "44 Years, 9 Months"
...
#    Then I verify grid "" column "Value" row "[4]" contains "44 Years, 9 Months"
...
#    Then I verify grid "" column "Value" row "[7]" contains "8 Years, 0 Months"
    ...
    Then I verify grid "" column "Value" row "[9]" contains "-"
    Then I verify grid "" column "Result" row "[9]" contains "Referred"
    ...
    Then I verify grid "" column "Value" row "[10]" contains "-"
    ...
    Then I verify grid "" column "Value" row "[11]" contains "-"
    ...
    Then I verify grid "" column "Value" row "[12]" contains "-"
    Then I verify grid "" column "Result" row "[12]" contains "Referred"
...
#    Verifying content on 'Credit Report - Applicant'
    Then I verify button "Re-Run Equifax Check" is present
...
#    Verifying content on 'Event History'
    Then I verify text "Reallocated Quote" is present
...
#    Verifying content on 'Quote Details'
    ...
    Then I verify field "Balloon Percentage" contains excel "excel:Balloon Percentage"
