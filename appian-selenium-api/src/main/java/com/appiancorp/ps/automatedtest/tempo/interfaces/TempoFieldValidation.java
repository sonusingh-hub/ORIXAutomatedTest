...
public class TempoFieldValidation extends AppianObject implements WaitForMultiple, Captureable {
    ...
    private static final Logger LOG = LogManager.getLogger(TempoFieldValidation.class);
    public static final String XPATH_RELATIVE_FIELD_VALIDATION_MESSAGE_SPECIFIC_VALUE =
            Settings.getByConstant("xpathRelativeFieldValidationMessageSpecificValue");
    public static final String XPATH_RELATIVE_FIELD_VALIDATION_MESSAGE =
            Settings.getByConstant("xpathRelativeFieldValidationMessage");
    ...
    public String capture(String... params) {
        WebElement fieldLayout =
                settings.getDriver().findElement(By.xpath(TempoField.getInstance(settings).getXpath(params)));
    ...
    public void waitFor(String... params) {
        ...
        if (LOG.isDebugEnabled()) {
            LOG.debug("WAIT FOR VALIDATION [" + validationMessage + "]");
        }
