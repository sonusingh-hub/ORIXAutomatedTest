...
public final class TempoTaskDeadline extends AppianObject implements WaitFor {

    private static final Logger LOG = LogManager.getLogger(TempoTaskDeadline.class);
    ...
    public void waitFor(String... params) {
        ...
        if (LOG.isDebugEnabled()) {
            LOG.debug("TASK [" + taskName + "] HAS DEADLINE [" + deadline + "]");
        }
