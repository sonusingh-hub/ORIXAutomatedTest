...
public final class TempoGridSelectAll extends TempoGrid implements Clickable {

    private static final Logger LOG = LogManager.getLogger(TempoGridSelectAll.class);
    private static final String XPATH_RELATIVE_GRID_SELECT_ALL_CHECKBOX =
            Settings.getByConstant("xpathRelativeGridSelectAllColumn");
    ...
    public void click(String... params) {
        ...
        if (LOG.isDebugEnabled()) {
            LOG.debug("CLICK SELECT ALL [" + gridName + "]");
        }
