...
public class TempoSectionField extends TempoSection implements
    ...
    private static final Logger LOG = LogManager.getLogger(TempoSectionField.class);
    ...
    public boolean contains(String... params) {
        ...
        WebElement fieldLayout = getWebElement(fieldName, sectionName);
        if (!TempoFieldFactory.getInstance(settings).contains(fieldLayout, fieldName, fieldValue)) {
            return false;
        }
        return true;
    }
