...
public final class TempoTaskReport extends AppianObject implements Clickable {

    private static final Logger LOG = LogManager.getLogger(TempoTaskReport.class);
    ...
    public void waitFor(String... params) {
        ...
        if (LOG.isDebugEnabled()) {
            LOG.debug("WAIT FOR TASK REPORT [" + taskReport + "]");
        }
    ...
    public void click(String... params) {
        ...
        if (LOG.isDebugEnabled()) {
            LOG.debug("CLICK TASK REPORT [" + taskReport + "]");
        }
