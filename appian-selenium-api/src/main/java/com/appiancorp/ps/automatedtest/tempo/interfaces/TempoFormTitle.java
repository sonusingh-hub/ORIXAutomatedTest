...
public final class TempoFormTitle extends AppianObject implements WaitFor, Captureable, RegexCaptureable {

    private static final Logger LOG = LogManager.getLogger(TempoFormTitle.class);
