...
public final class TempoRecordType extends AppianObject implements Clickable {

    private static final Logger LOG = LogManager.getLogger(TempoRecordType.class);
    private static final String XPATH_ABSOLUTE_RECORD_TYPE_LINK = Settings.getByConstant("xpathAbsoluteRecordTypeLink");
    private static final String XPATH_ABSOLUTE_RECORD_TYPE_LINK_INDEX =
            "(" + XPATH_ABSOLUTE_RECORD_TYPE_LINK + ")[%2$d]";
    ...
    public void click(String... params) {
        ...
        if (LOG.isDebugEnabled()) {
            LOG.debug("CLICK RECORD TYPE [" + type + "]");
        }
    ...
    public void waitFor(String... params) {
        ...
        if (LOG.isDebugEnabled()) {
            LOG.debug("WAIT FOR RECORD TYPE [" + type + "]");
        }
