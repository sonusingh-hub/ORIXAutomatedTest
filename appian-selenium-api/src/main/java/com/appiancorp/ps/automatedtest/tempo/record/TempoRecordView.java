...
public final class TempoRecordView extends AppianObject implements Clickable {

    private static final Logger LOG = LogManager.getLogger(TempoRecordView.class);
    ...
    public void click(String... params) {
        ...
        if (LOG.isDebugEnabled()) {
            LOG.debug("CLICK ON RECORD VIEW [" + view + "]");
        }
    ...
    public void waitFor(String... params) {
        ...
        if (LOG.isDebugEnabled()) {
            LOG.debug("WAIT FOR RECORD VIEW [" + view + "]");
        }
