...
public class Version implements Comparable<Version> {
     ...
     *
     * @param version string of version to parse in x.x.x.x format
     * @param actual  string of actual - used for hotfix versioning
    ...
    public static Version parse(String version, String actual) {
        ...
        try {
            ...
            IllegalArgumentException iae =
                    new IllegalArgumentException("Invalid version \"" + version + "\": invalid format");
            iae.initCause(e);
            throw iae;
     ...
     *
     * @param version  the version to match to
     * @param versions the list of versions to match against
     * @return
     */
