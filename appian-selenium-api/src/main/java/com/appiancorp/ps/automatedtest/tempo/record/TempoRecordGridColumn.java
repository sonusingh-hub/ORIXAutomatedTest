...
public final class TempoRecordGridColumn extends AppianObject implements Clickable {

    private static final Logger LOG = LogManager.getLogger(TempoRecord.class);
    private static final String XPATH_ABSOLUTE_RECORD_GRID_COLUMN_SORT_LINK =
            Settings.getByConstant("xpathAbsoluteRecordGridColumnSortLink");
    ...
    public void waitFor(String... params) {
        ...
        if (LOG.isDebugEnabled()) {
            LOG.debug("WAIT FOR COLUMN [" + columnName + "]");
        }
    ...
    public void click(String... params) {
        ...
        if (LOG.isDebugEnabled()) {
            LOG.debug("CLICK ON COLUMN [" + columnName + "]");
        }
