...
public class TempoNewsItem extends AppianObject implements Refreshable, Clearable, RegexCaptureable {
    ...
    public boolean waitForReturn(boolean waitForPresent, int timeout, String... params) {
        ...
        if (LOG.isDebugEnabled()) {
            LOG.debug("WAIT FOR REFRESH [" + newsText + "]");
        }
    ...
    public void clear(String... params) {
        ...
        if (LOG.isDebugEnabled()) {
            LOG.debug("DELETE NEWS ITEM [" + newsText + "]");
        }

        try {
            WebElement element = settings.getDriver()
                    .findElement(By.xpath(xpathFormat(XPATH_ABSOLUTE_NEWS_ITEM_DELETE_LINK, newsText)));
            element.click();
    ...
    public String regexCapture(String regex, Integer group, String... params) {
        ...
        if (LOG.isDebugEnabled()) {
            LOG.debug("NEWS ITEM [" + newsText + "] REGEX [" + regex + "]");
        }
