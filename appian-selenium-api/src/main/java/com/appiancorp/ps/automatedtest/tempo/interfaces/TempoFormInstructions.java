...
public final class TempoFormInstructions extends AppianObject implements WaitFor, Captureable {

    private static final Logger LOG = LogManager.getLogger(TempoFormInstructions.class);
    private static final String XPATH_ABSOLUTE_FORM_INSTRUCTIONS =
            Settings.getByConstant("xpathAbsoluteFormInstructions");
    ...
    public String capture(String... params) {
        if (LOG.isDebugEnabled()) {
            LOG.debug("GET FORM INSTRUCTIONS");
        }
    ...
    public void waitFor(String... params) {
        if (LOG.isDebugEnabled()) {
            LOG.debug("WAIT FOR FORM INSTRUCTIONS");
        }
