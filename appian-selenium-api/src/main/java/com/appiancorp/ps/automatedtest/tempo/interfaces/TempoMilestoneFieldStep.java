...
public final class TempoMilestoneFieldStep extends TempoMilestoneField implements Clickable {

    private static final Logger LOG = LogManager.getLogger(TempoMilestoneFieldStep.class);
    private static final String XPATH_RELATIVE_MILESTONE_STEP = Settings.getByConstant("xpathRelativeMilestoneStep");
    private static final String XPATH_RELATIVE_MILESTONE_STEP_INDEX =
            Settings.getByConstant("xpathRelativeMilestoneStepIndex");
    ...
    public void click(String... params) {
        ...
        if (LOG.isDebugEnabled()) {
            LOG.debug("CLICK ON MILESTONE [" + milestone + "] STEP [" + step + "]");
        }
