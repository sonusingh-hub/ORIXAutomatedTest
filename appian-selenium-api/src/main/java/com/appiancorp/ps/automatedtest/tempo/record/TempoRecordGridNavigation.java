...
public final class TempoRecordGridNavigation extends AppianObject implements Clickable {

    private static final Logger LOG = LogManager.getLogger(TempoRecord.class);
    private static final String XPATH_ABSOLUTE_RECORD_GRID_NAVIGATION_FIRST =
            Settings.getByConstant("xpathAbsoluteRecordGridNavigationFirst");
    private static final String XPATH_ABSOLUTE_RECORD_GRID_NAVIGATION_PREVIOUS =
            Settings.getByConstant("xpathAbsoluteRecordGridNavigationPrevious");
    private static final String XPATH_ABSOLUTE_RECORD_GRID_NAVIGATION_NEXT =
            Settings.getByConstant("xpathAbsoluteRecordGridNavigationNext");
    private static final String XPATH_ABSOLUTE_RECORD_GRID_NAVIGATION_LAST =
            Settings.getByConstant("xpathAbsoluteRecordGridNavigationLast");
    ...
    public void waitFor(String... params) {
        ...
        if (LOG.isDebugEnabled()) {
            LOG.debug("WAIT FOR NAVIGATION [" + navOption + "]");
        }
    ...
    public void click(String... params) {
        ...
        if (LOG.isDebugEnabled()) {
            LOG.debug("CLICK ON NAVIGATION [" + navOption + "]");
        }
