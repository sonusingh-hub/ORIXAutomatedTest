...
public final class TempoMenu extends AppianObject implements WaitFor, Clickable {

    private static final Logger LOG = LogManager.getLogger(TempoMenu.class);
