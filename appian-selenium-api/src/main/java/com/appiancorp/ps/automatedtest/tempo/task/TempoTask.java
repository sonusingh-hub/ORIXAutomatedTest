...
public final class TempoTask extends AppianObject implements Refreshable, Clickable, RegexCaptureable {

    private static final Logger LOG = LogManager.getLogger(TempoTask.class);
    ...
    public void waitFor(String... params) {
        ...
        if (LOG.isDebugEnabled()) {
            LOG.debug("WAIT FOR TASK [" + taskName + "]");
        }
    ...
    public String regexCapture(String regex, Integer group, String... params) {
        ...
        if (LOG.isDebugEnabled()) {
            LOG.debug("REGEX FOR TASK [" + regex + "]");
        }
