...
public class TempoFields2Factory extends AppianObject implements
    ...
    private static final Logger LOG = LogManager.getLogger(TempoFields2Factory.class);
...
//            Settings.getByConstant("xpathRelativeFieldLayoutLabel");
    public static final String XPATH_ABSOLUTE_FIELD_LAYOUT_LABEL2 =
            Settings.getByConstant("xpathAbsoluteFieldLayoutLabel2");
    public static TempoFields2Factory getInstance(Settings settings) {
        return new TempoFields2Factory(settings);
    }

    protected TempoFields2Factory(Settings settings) {
        super(settings);
    }
...
//    }
    public String getLabels(WebElement fieldLayout) {
        return fieldLayout.findElement(By.xpath(XPATH_ABSOLUTE_FIELD_LAYOUT_LABEL2)).getText();
    }
}
