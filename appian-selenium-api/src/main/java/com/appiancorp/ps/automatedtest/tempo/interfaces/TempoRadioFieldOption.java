...
public final class TempoRadioFieldOption extends TempoRadioField implements Clickable {

    private static final Logger LOG = LogManager.getLogger(TempoRadioFieldOption.class);
    private static final String XPATH_ABSOLUTE_RADIO_FIELD_OPTION =
            Settings.getByConstant("xpathAbsoluteRadioFieldOption");
    private static final String XPATH_ABSOLUTE_RADIO_FIELD_OPTION_INDEX =
            "(" + XPATH_ABSOLUTE_RADIO_FIELD_OPTION + ")[%2$d]";
    ...
    public void waitFor(String... params) {
        ...
        if (LOG.isDebugEnabled()) {
            LOG.debug("WAIT FOR RADIO BUTTON OPTION CLICK : " + optionName);
        }
